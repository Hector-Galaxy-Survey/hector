...
try:
    ...
    warning_message = (
      ...
      + ' please exit python, then navigate to the directory where the HECTOR\n'
      + 'pipeline is located (enter hector.__path__ in the python interpreter\n'
      ...
      + '`utils` of the hector path, you can open the python interpreter and \n'
      + 'try to import the hector manager again. If problems persists, please\n'
      + 'see a doctor.\n\n'
